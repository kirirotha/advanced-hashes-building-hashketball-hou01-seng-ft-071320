...
def game_hash
  #game_hash = {:home => {:team_name => "Brooklyn Nets", :colors => ["Black", "White"], :players => {:player_name => {}, :number => {}, :shoe => {}, :points => {}, :rebounds => {}, :assists => {}, :steals => {}, :blocks => {}, :slam_dunks => {}}}}, {:away => {:team_name => {}, :colors => {}, :players => {:player_name => {}, :number => {}, :shoe => {}, :points => {}, :rebounds => {}, :assists => {}, :steals => {}, :blocks => {}, :slam_dunks => {}}}}
 ...
 #{mason_plumee = [:player_name => "Mason Plumee", :number => 1, :shoe => 19, :points => 26, :rebounds => 11, :assists => 6, :steals => 3, :blocks => 8, :slam_dunks => 5]},
   ...
   #                       :reggie_evans => [:player_name => "Reggie Evans", :number => 30, :shoe => 14, :points => 12, :rebounds => 12, :assists => 12, :steals => 12, :blocks => 12, :slam_dunks => 7],
     ...
     #                     :jeff_adrien => [:player_name => "Jeff Adrien", :number => 4, :shoe => 18, :points => 10, :rebounds => 1, :assists => 1, :steals => 2, :blocks => 7, :slam_dunks => 2]
      ...
      #                    :bismack_biyombo => [:player_name => "Bismack Biyombo", :number => 0, :shoe => 16, :points => 12, :rebounds => 4, :assists => 7, :steals => 22, :blocks => 15, :slam_dunks => 10]
             ...
             #             :desagna_diop => "DeSagna Diop", :number => 2, :shoe => 14, :points => 24 , :rebounds => 12, :assists => 12, :steals => 4, :blocks => 5, :slam_dunks => 5]
